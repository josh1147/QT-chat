                                ...
                                ui(new Ui::login)
{
    ...
    ui->loginbtn->setStyleSheet("color : yellow;"
                                "width : 50px;");
    this->setStyleSheet(
    ...
    ui->loginbtn->setStyleSheet("QPushButton{font: 25 14pt '微软雅黑 Light';color: yellow;"
                                ...
                                "QPushButton:hover{background-color: rgb(22,218,208);}"     // hover
                                "QPushButton:pressed{background-color: rgb(17,171,164);}"); // pressed
    ui->label->setStyleSheet("font: 25 15pt '微软雅黑 Light';"
                             "background-color:rgba(255,255,255,0)");
    ui->label_2->setStyleSheet("font: 25 12pt '微软雅黑 Light';"
                               "background-color:rgba(255,255,255,0)");
    ui->label_3->setStyleSheet("font: 25 12pt '微软雅黑 Light';"
                               "background-color:rgba(255,255,255,0)");
}
